    ...
    if a == 1:
        ...
        if float(version.text) > 1.0:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O raw.githubusercontent.com/Cryptonian007/Astra/main/add.py')
                os.system('curl -l -O raw.githubusercontent.com/Cryptonian007/Astra/main/manager.py')
